...
if st.button("تحليل التغريدة 🚀"):
    if user_input.strip() == "":
        ...
        with st.spinner('جاري تحليل التغريدة...'):
            ...
            negative_words = ['سيء', 'حزين', 'زعلان', 'كارثة', 'مشكلة', 'خربان', 'فاشل', 'سيئه', 'مرعب', 'مؤلم', 'زعلان', 'زعلانة', 'فشل', 'وفاة', 'استشهاد', 'وحش', 'تعبان', 'تعبانة', 'موت', 'بايظ', 'فشلت', 'زهقت', 'وحشة', 'سيئة', 'اوحش', 'زفت']
            score = 0.5
