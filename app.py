...
if st.button("تحليل التغريدة 🚀"):
    if user_input.strip() == "":
        ...
        with st.spinner('جاري تحليل التغريدة...'):
            ...
            positive_words = ['سعيد', 'فرح', 'جميل', 'رائع', 'ممتاز', 'حب', 'حلو', 'افضل', 'نجاح', 'فرحانة', 'جدا', 'عظيم', 'تسلم', 'نجحت', 'مبسوط', 'مبسوطة', 'فرحان', 'احلي', 'اجمل', 'فخور', 'فخورة', 'شكرا']
            negative_words = ['سيء', 'حزين', 'حزن', 'زعلان', 'كارثة', 'مشكلة', 'خربان', 'فاشل', 'سيئه', 'مرعب', 'مؤلم', 'زعلان', 'زعلانة', 'فشل', 'وفاة', 'استشهاد', 'وحش', 'تعبان', 'تعبانة', 'موت', 'بايظ', 'فشلت', 'زهقت', 'وحشة', 'سيئة', 'اوحش', 'زفت']
            score = 0.5
